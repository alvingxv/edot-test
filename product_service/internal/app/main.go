...
import (
	...
	"product-service/pkg/httpclient"
...
func NewApp(ctx context.Context) (*App, error) {
	...
	httpclient.Client.NewCbSource(
		httpclient.Client.CbWithCommand("user_service"),        // Name of the circuit breaker for this service
		httpclient.Client.CbWithErrorPercentThreshold(50),      // Open the circuit if 50% of requests fail
		httpclient.Client.CbWithFallbackMsg("user_service Timeout"), // Message to return when the circuit is open
